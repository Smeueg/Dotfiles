...
(let ((base0 "#202020") (base8 "#404040")
  ...
  (custom-theme-set-faces
   ...
   `(ansi-color-bright-black ((,display (:foreground ,base0 :background ,base0))))
   `(ansi-color-bright-red ((,display (:foreground ,base1 :background ,base1))))
   `(ansi-color-bright-green ((,display (:foreground ,base2 :background ,base2))))
   `(ansi-color-bright-yellow ((,display (:foreground ,base3 :background ,base3))))
   `(ansi-color-bright-blue ((,display (:foreground ,base4 :background ,base4))))
   `(ansi-color-bright-magenta ((,display (:foreground ,base5 :background ,base5))))
   `(ansi-color-bright-cyan ((,display (:foreground ,base6 :background ,base6))))
   `(ansi-color-bright-white ((,display (:foreground ,base7 :background ,base7))))
   ;; Highlight faces
